    ...
    <div id="skills">
      <div className=" container m-auto  mt-16">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                {/* <ProgressBar
                  ...
                  value={80}
                />
                <ProgressBar logo={<SiFigma />} name={"Figma"} value={80} />
                <ProgressBar logo={<SiPostgresql />} name={"PostgreSQL"} value={80} /> */}
              </div>
            </div>
          </div>
          {/* right box */}
        ...
        >
          ...
          <img
            className="w-[40px] h-[40px] md:w-[35px] md:h-[35px]"
            src="https://img.icons8.com/color/48/null/adobe-illustrator.png"
          />
          <img
            className="w-[40px] h-[40px] md:w-[35px] md:h-[35px]"
            src="https://img.icons8.com/color/48/null/adobe-xd.png"
          />
          {/* <img
            className="w-[40px] h-[40px] md:w-[35px] md:h-[35px]"
